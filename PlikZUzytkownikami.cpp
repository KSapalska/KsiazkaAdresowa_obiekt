...
void PlikZUzytkownikami::dopiszUzytkownikaDoPliku(Uzytkownik uzytkowink)
{
    ...
    {
        liniaZDanymiUzytkownika = zamienDaneUzytkownikaNaLinieZDanymiOddzielonaPionowymiKreskami(uzytkowink);
...
string PlikZUzytkownikami::zamienDaneUzytkownikaNaLinieZDanymiOddzielonaPionowymiKreskami(Uzytkownik uzytkownik)
{
 ...
 vector <Uzytkownik> PlikZUzytkownikami::wczytajUzytkownikowZPlkiu()
 {
